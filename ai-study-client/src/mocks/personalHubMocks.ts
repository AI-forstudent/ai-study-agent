...
export const MOCK_COURSES: CourseRecord[] = [
  {
    ...
    status: 'completed', grade: 92, semester_taken: null, exam_date_a: '2024-02-05T00:00:00.000Z', exam_date_b: null, is_attendance_mandatory: false, created_at: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 2, user_id: 1, course_id: 2,
    course: { id: 2, name: 'Data Structures', department: 'Computer Science', credits: 4.0, icon_name: 'GitBranch' },
    status: 'completed', grade: 88, semester_taken: null, exam_date_a: '2024-06-20T00:00:00.000Z', exam_date_b: null, is_attendance_mandatory: false, created_at: '2024-02-15T00:00:00.000Z',
  },
  {
    id: 3, user_id: 1, course_id: 3,
    course: { id: 3, name: 'Algorithms', department: 'Computer Science', credits: 4.0, icon_name: 'Zap' },
    status: 'completed', grade: 84, semester_taken: null, exam_date_a: '2024-06-25T00:00:00.000Z', exam_date_b: null, is_attendance_mandatory: true, created_at: '2024-02-15T00:00:00.000Z',
  },
  {
    id: 4, user_id: 1, course_id: 4,
    course: { id: 4, name: 'Databases', department: 'Data Engineering', credits: 3.0, icon_name: 'Database' },
    status: 'completed', grade: 91, semester_taken: null, exam_date_a: '2024-06-22T00:00:00.000Z', exam_date_b: null, is_attendance_mandatory: false, created_at: '2024-02-15T00:00:00.000Z',
  },
  {
    id: 5, user_id: 1, course_id: 5,
    course: { id: 5, name: 'Linear Algebra', department: 'Mathematics', credits: 4.0, icon_name: 'Grid' },
    status: 'completed', grade: 78, semester_taken: null, exam_date_a: '2024-06-18T00:00:00.000Z', exam_date_b: null, is_attendance_mandatory: true, created_at: '2024-02-15T00:00:00.000Z',
  },
  {
    id: 6, user_id: 1, course_id: 6,
    course: { id: 6, name: 'Probability & Statistics', department: 'Mathematics', credits: 4.0, icon_name: 'BarChart2' },
    status: 'active', grade: null, semester_taken: null, exam_date_a: '2026-06-15T00:00:00.000Z', exam_date_b: null, is_attendance_mandatory: false, created_at: '2026-02-10T00:00:00.000Z',
  },
  {
    ...
    status: 'active', grade: null, semester_taken: null, exam_date_a: '2026-06-28T00:00:00.000Z', exam_date_b: null, is_attendance_mandatory: true, created_at: '2026-02-10T00:00:00.000Z',
  },
];
