...
import { ChevronDown, Download, Brain } from 'lucide-react';
import { getFileIconConfig } from '../../utils/fileIcons';

interface WorkspaceHeaderProps {
  documentTitle: string;
  onExportSession?: () => void;
  /** Called when the user clicks "Save to AI Teacher Memory" — triggers the wrap-up modal. */
  onSaveMemory?: () => void;
}
